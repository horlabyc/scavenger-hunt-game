...
export const TASKS: Task[] = [
  {
    id: 't1',
    category: 'PHOTO',
    title: 'Snap with the CEO and CTO',
    description: 'Get a fun photo with Mallick and Kelechi together, make it memorable and unique!',
    score: 15,
  },
  {
    id: 't2',
    category: 'PHOTO',
    title: 'Picture of Startbutton by the beach',
    description: 'Take a creative and clear picture of Startbutton written boldy on the sand! ',
    score: 15,
  },
  {
    id: 't3',
    category: 'PHOTO',
    title: "Find something in the company's color",
    description: "Find and photograph something in Starbutton's color within the resort.",
    score: 10,
  },
  {
    id: 't4',
  ...
  },
  {
    ...
    description: 'Collect autographs from 3 people outside your group and take the picture!',
    score: 10,
  },
  {
    id: 't8',
    category: 'VIDEO',
    title: 'Gym or fitness-related challenge',
    description: 'Take a video of the team planking by the sea for 10secs',
    score: 10,
  },
  {
    id: 't9',
